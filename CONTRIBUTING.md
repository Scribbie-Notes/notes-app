...
│   
├── backend/                  # All the backend development files included here
│   
├── frontend/                 # All the frontend development files included here
│   
├── .gitignore               
│     
...
├── package.json      
│   
├── README.md                 # Some instructions about contributions
│   
├── todo                  
```
...
1. Navigate to the project's issues section :- [Issues](https://github.com/Scribbie-Notes/notes-app/issues/new)
