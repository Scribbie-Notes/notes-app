    ...
    <div className="h-full scroll-smooth">
      ...
      <section className="bg-white pt-12" ref={whiteSectionRef}>
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 pl-16">
          <div className="mr-auto place-self-center lg:col-span-7 sm:mr-0 sm:place-self-start">
            <h1
              ref={heroText}
              className="max-w-2xl mb-2 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-gray-900 text-3xl sm:text-4xl"
            >
              Capture Ideas,
            </h1>
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-gray-900 text-3xl sm:text-4xl">
          ...
          {/* Hero Image on Desktop, Hidden on Mobile */}
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex hero-image pr-16">
            <img src={hero2} alt="landing-pic" className="w-full h-auto" />
          </div>
