...
const ProfileInfo = ({ userInfo, onLogout }) => {
    ...
    return (
        <div className='relative' ref={dropdownRef}>
            <div className='w-12 h-12 flex items-center hover:bg-slate-200 justify-center p-3 rounded-full text-slate-950 font-medium bg-slate-100 cursor-pointer transition-all' onClick={toggleDropdown}>
